...
export const resorts: Resort[] = [
  ...
  },
  {
    ...
    description: "Park City Mountain Resort is the largest ski resort in the United States, offering endless terrain options and a charming mountain town experience."
  },
  {
    id: "mammoth",
    ...
    description: "Mammoth Mountain is California's highest ski resort, known for its long season, abundant snowfall, and stunning Sierra Nevada views."
  },
  {
    id: "jackson-hole",
    ...
    description: "Jackson Hole Mountain Resort is famous for its steep terrain, deep powder, and iconic Teton Mountain backdrop."
  },
  {
    id: "steamboat",
    ...
    description: "Steamboat is famous for its Champagne Powder® snow and western hospitality, offering excellent tree skiing and family-friendly terrain."
  },
  {
    id: "killington",
    ...
    description: "Known as 'The Beast of the East,' Killington is the largest ski resort in Eastern North America with six peaks and diverse terrain."
  },
  {
    id: "snowbird",
    name: "Snowbird",
    ...
    description: "Snowbird is known for its deep powder snow, steep terrain, and iconic aerial tram, offering some of Utah's most challenging skiing."
  },
  {
    id: "big-sky",
    name: "Big Sky Resort",
    ...
    description: "Big Sky Resort offers the Biggest Skiing in America with 5,850 acres of terrain and the iconic Lone Peak Tram."
  },
  {
    id: "palisades-tahoe",
    ...
    description: "Home to the 1960 Winter Olympics, Palisades Tahoe offers world-class terrain across two mountains with stunning Lake Tahoe views."
  }
];
